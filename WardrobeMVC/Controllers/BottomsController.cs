...
namespace WardrobeMVC.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,BottomName,BottomPhoto,BottomType,BottomColor,BottomSeason,BottomOccassion")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,BottomName,BottomPhoto,BottomType,BottomColor,BottomSeason,BottomOccassion")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
