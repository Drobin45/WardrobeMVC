...
namespace WardrobeMVC.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoesID,ShoesName,ShoesPhoto,ShoesType,ShoesColor,ShoesSeason,ShoesOccassion")] Sho sho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoesID,ShoesName,ShoesPhoto,ShoesType,ShoesColor,ShoesSeason,ShoesOccassion")] Sho sho)
        {
            if (ModelState.IsValid)
            {
